...
directory = '/Users/az/Desktop/YouTubeTutorials-main/files/Doublet_finder_github/raw_feature_bc_matrix'

# create counts matrix
cts <- ReadMtx(mtx = paste0(directory,'/matrix.mtx.gz'),
        features = paste0(directory, '/features.tsv.gz'),
        cells = paste0(directory, '/barcodes.tsv.gz'))
